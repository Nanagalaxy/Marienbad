...
class MarienbadJvsO
{
	...
	* @param String nom2
	*/
	void jeu(int[] plateau, String nomJ, boolean AQuiLeTour)
	{
	...
	* @param int[] t
	*/
	void modifJeuOrdiPerdant(int[] t)
	{
	...
	* @param int[] t - copie du plateau de jeu
	* @return int[] tabRepBinaire - tableau contenant les données utiliser
	* par la méthode pairsImpairs() (ex: 2 2 4).
	*/
	int[] conversionBinaireCalculColonne(int[] t)
	{
	...
	* @param int[] t - résultat donné par la méthode conversionBinaireCalculColonne()
	* @return boolean impair - si le résultat est pair, impair = true sinon impair = false
	*/
	boolean pairsImpairs (int[] t)
	{
		boolean impair = true;
